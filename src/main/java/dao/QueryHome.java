...
public class QueryHome {
	...
	public Query merge(Query detachedInstance) {
		...
		try {
			Query result = (Query) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Query findById(QueryId id) {
		...
		try {
			Query instance = (Query) sessionFactory.getCurrentSession().get(
					"Query", id);
			if (instance == null) {
	...
	public List findByExample(Query instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Query").add(Example.create(instance))
					.list();
